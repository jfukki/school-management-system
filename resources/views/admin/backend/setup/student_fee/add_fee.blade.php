	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Add Student fee</h3>
                    ...
                    <form action="{{route('student.fee.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                                ...
                                <div class="controls">
                                    <input type="text" name="name" id="name"
                                     class="form-control"  value="" placeholder="Enter fee Here...." > </div>
                        ...
                        <div class="col">
                                    <div class="text-xs-right">
                                        <br>
                                    <button type="submit" class="btn btn-rounded btn-primary btn-outline">Add fee</button>
                            </div>
