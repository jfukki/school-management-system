		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
                    <form action="{{route('student.class.add')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">                               
                        ...
                        <div class="col-12">
                                ...
                                <div class="controls">
                                    <input type="text" name="name" id="name"
                                     class="form-control"  value="" placeholder="Enter Class Title Here...." > </div>
                        ...
                        <div class="col">
                                    ...
                                    <button type="submit" class="btn btn-rounded btn-primary btn-outline">Add Class</button>
                            </div>
