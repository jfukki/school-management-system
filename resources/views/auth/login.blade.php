							...
							<form action="{{ route('login') }}" method="post">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" name="email" id="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Enter Your Email" value="{{old('email')}}">
                                        @error('email')
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" name="password" id="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Please Enter Your Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
