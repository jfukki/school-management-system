...
<head>
  <meta charset="utf-8">
    ...
    <title>School ERP - User Registeration </title>
							...
							<form action="{{ route('register') }}" method="post">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Full Name" name="name" value="{{old('name')}}" >
                                        @error('name')
                                            {{$message}}
                                        @enderror
									</div>
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email" name="email" value="{{old('email')}}" >
                                        @error('email')
                                            {{$message}}
                                        @enderror
									</div>
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Retype Password" name="password_confirmation" >
